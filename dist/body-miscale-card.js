...
.scroll-wrapper {
  max-height: 40vh; /* hauteur max dynamique (viewport height) */
  overflow-y: auto;
...
@media (max-width: 400px) {
    ...
    `:R}renderState(e){var a,o,i,t,l;if(!this.config.show_states)return R;if(!this.hass||!(null===(a=this.config)||void 0===a?void 0:a.entity))return G`<div>${Jt("state.default.unavailable")}</div>`;const n=null===(o=this.hass.states)||void 0===o?void 0:o[this.config.entity];if(!n)return G`<div>
      ...
      ${null!==(t=e.label)&&void 0!==t?t:""}${h}${null!==(l=e.unit)&&void 0!==l?l:""}
          ...
          <ha-icon
            ...
            "
          ></ha-icon>
        `:R,u=e.label?G`<div class="name">${e.label}</div>`:R,m="number"==typeof c?this.renderColorBarSegments(e,c,!1):R,g=m!==R,p=g?"bar-container":"bar-container compact",y=e.positions.icon,w=e.positions.name,f=e.positions.minmax,v=e.positions.value,k="off"!==y?h:R,z="off"!==w?u:R;let $=R,A=0,x=100;if("off"!==f&&e.severity){const a=this.getMinMaxFromSeverity(e.severity);A=a.min,x=a.max,$=G`
        <div class="minmax">
          ${Jt("editor_body.minmax_label")}
          <span class="min">${A}</span>/<span class="max">${x}</span>
        </div>`}const M="off"!==v?G`<div class="value">${Jt(`body_value.${c}`)||_}${e.unit||""}</div>`:R,P=["right"===y?k:R,"right"===w?z:R,"right"===f?$:R,"right"===v?M:R];return G`
    <div style="display: flex; flex-direction: column; padding: 0.4rem 0 0.4rem; ${g?"":"justify-content: center; align-items: center;"}">
      <div class="flex-container" style="${g?"justify-content: space-between; width: 100%;":"width: 100%;"}">
        <div style="display: flex; align-items: center; gap: 1rem;">
          ${["left"===y?k:R,"left"===w?z:R,"left"===f?$:R,"left"===v?M:R].filter((e=>e!==R))}
        </div>
  ...
  `}getMinMaxFromSeverity(e){let a=1/0,o=-1/0;return e&&Array.isArray(e)&&e.forEach((e=>{const i=e.from,t=e.to;let l,n;if("number"==typeof i)l=i;else if("string"==typeof i&&"min"!==i){const e=parseFloat(i);isNaN(e)?"min"===i&&(l=-1/0):l=e}else"min"===i&&(l=-1/0);if("number"==typeof t)n=t;else if("string"==typeof t&&"max"!==t){const e=parseFloat(t);isNaN(e)?"max"===t&&(n=1/0):n=e}else"max"===t&&(n=1/0);void 0===l||isNaN(l)||(a=Math.min(a,l)),void 0===n||isNaN(n)||(o=Math.max(o,n))})),{min:a===1/0?0:a,max:o===-1/0?100:o}}_computePercent(e,a){if(!e||"number"!=typeof a)return 0;const o=e.max-e.min;return o<=0?0:(a-e.min)/o*100}renderColorBarSegments(e,a,o=!0){const{min:i,max:t}=this.getMinMaxFromSeverity(e.severity||[]),l=t-i;if(!e.severity||!Array.isArray(e.severity)||l<=0)return R;const n=e.severity.filter((e=>"disabled"!==e.color&&null!==e.from&&null!==e.to&&void 0!==e.color));if(0===n.length)return R;const r=n.map(((a,o)=>{const r=parseFloat(a.from)||i,s=parseFloat(a.to)||t,d=(s-r)/l*100,c=al(a.color)||"gray",_="false"!==e.showabovelabels,b="false"!==e.showbelowlabels,h=_&&o!==n.length-1?G`<div class="segment-label-above" style="color: ${c};">${ke(s,this.hass.locale)}${e.unit||""}</div>`:R,u=b&&a.label?G`<div class="segment-label-below" style="color: ${c};">${Jt(`label_below.${a.label}`)||a.label||""}</div>`:R;return G`
    ...
    >
      ...
      `;const l=xe(null!==(a=this.config.body)&&void 0!==a?a:{},this.config.model),n=xe(null!==(o=this.config.attributes)&&void 0!==o?o:{},this.config.model);return G`
      <ha-card>
    ...
    `}};e([_e({attribute:!1})],_l.prototype,"hass",void 0),e([be()],_l.prototype,"config",void 0),e([be()],_l.prototype,"open",void 0),_l=e([se("body-miscale-card")],_l),window.customCards=window.customCards||[],window.customCards.push({preview:!0,type:"body-miscale-card",name:Jt("common.name"),description:Jt("common.description")});const bl=1;let hl=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,a,o){this._$Ct=e,this._$AM=a,this._$Ci=o}_$AS(e,a){return this.update(e,a)}update(e,a){return this.render(...a)}};const ul="important",ml=" !"+ul,gl=(e=>(...a)=>({_$litDirective$:e,values:a}))(class extends hl{constructor(e){if(super(e),e.type!==bl||"style"!==e.name||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((a,o)=>{const i=e[o];return null==i?a:a+`${o=o.includes("-")?o:o.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`}),"")}update(e,[a]){const{style:o}=e.element;if(void 0===this.ft)return this.ft=new Set(Object.keys(a)),this.render(a);for(const e of this.ft)null==a[e]&&(this.ft.delete(e),e.includes("-")?o.removeProperty(e):o[e]=null);for(const e in a){const i=a[e];if(null!=i){this.ft.add(e);const a="string"==typeof i&&i.endsWith(ml);e.includes("-")||a?o.setProperty(e,a?i.slice(0,-11):i,a?ul:""):o[e]=i}}return U}});let pl=class extends ne{constructor(){super(...arguments),this.configValue=""}_selectChanged(e){const a=e.target.value;this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:a||void 0}}))}render(){return G`
      <ha-select
    ...
    `}};e([_e()],pl.prototype,"label",void 0),e([_e()],pl.prototype,"value",void 0),e([_e()],pl.prototype,"configValue",void 0),pl=e([se("color-select")],pl);var yl=n`.card-config {
  display: block;
}
        ...
        ${i.map(((e,o)=>{var i,t,l,n;return G`
              <div class="severity-row">
                ...
                <div class="below-line">
                  <ha-textfield
                    .label=${Jt("editor_body.label_below")}
                  ...
                  <div class="severity-icons">
                    ...
                    <ha-icon-button
                      ...
                      .label="${Jt("editor_body.severity_generator_help")}"
                    >
