...
@media (max-width: 400px) {
  ...
  .segment-label {
    ...
    >
      ...
      `;const l=Ae(null!==(a=this.config.body)&&void 0!==a?a:{},this.config.model);console.log("filteredBodyData in render:",l);const n=Ae(null!==(o=this.config.attributes)&&void 0!==o?o:{},this.config.model);return L`
      <ha-card>
