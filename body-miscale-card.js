...
input.divcheck:checked + div {
  display:block;
    ...
    `}}),window.customCards=window.customCards||[],window.customCards.push({preview:!0,type:"bodymiscale-card",name:je("common.name"),description:je("common.description")});
