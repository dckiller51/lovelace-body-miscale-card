 ...
 * http://polymer.github.io/PATENTS.txt
 */
const p=new WeakMap,b=e=>"function"==typeof e&&p.has(e),_={},m={};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function $(e){let t=T.get(e.type);void 0===t&&(t={stringsArray:new WeakMap,keyString:new Map},T.set(e.type,t));let s=t.stringsArray.get(e.strings);if(void 0!==s)return s;const a=e.strings.join(i);return s=t.keyString.get(a),void 0===s&&(s=new o(e,e.getTemplateElement()),t.keyString.set(a,s)),t.stringsArray.set(e.strings,s),s}const T=new Map,E=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(e,t,i,s){const a=t[0];if("."===a){return new M(e,t.slice(1),i).parts}if("@"===a)return[new O(e,t.slice(1),s.eventContext)];if("?"===a)return[new P(e,t.slice(1),i)];return new S(e,t,i).parts}handleTextExpression(e){return new x(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const j=(e,...t)=>new y(e,t,"html",B)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
*/
const F="adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,W=Symbol();class K{constructor(e,t){if(t!==W)throw new Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e}get styleSheet(){return void 0===this._styleSheet&&(F?(this._styleSheet=new CSSStyleSheet,this._styleSheet.replaceSync(this.cssText)):this._styleSheet=null),this._styleSheet}toString(){return this.cssText}}const G=(e,...t)=>{const i=t.reduce(((t,i,s)=>t+(e=>{if(e instanceof K)return e.cssText;if("number"==typeof e)return e;throw new Error(`Value passed to 'css' function must be a 'css' function result: ${e}. Use 'unsafeCSS' to pass non-literal values, but\n            take care to ensure page security.`)})(i)+e[s+1]),e[0]);return new K(i,W)};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
(window.litElementVersions||(window.litElementVersions=[])).push("2.3.1");const J={};class Z extends L{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const e=this.getStyles();if(void 0===e)this._styles=[];else if(Array.isArray(e)){const t=(e,i)=>e.reduceRight(((e,i)=>Array.isArray(i)?t(i,e):(e.add(i),e)),i),i=t(e,new Set),s=[];i.forEach((e=>s.unshift(e))),this._styles=s}else this._styles=[e]}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const e=this.constructor._styles;0!==e.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?F?this.renderRoot.adoptedStyleSheets=e.map((e=>e.styleSheet)):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(e.map((e=>e.cssText)),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(e){const t=this.render();super.update(e),t!==J&&this.constructor.render(t,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach((e=>{const t=document.createElement("style");t.textContent=e.cssText,this.renderRoot.appendChild(t)})))}render(){return J}}Z.finalized=!0,Z.render=(e,i,s)=>{if(!s||"object"!=typeof s||!s.scopeName)throw new Error("The `scopeName` option is required.");const a=s.scopeName,o=E.has(i),n=D&&11===i.nodeType&&!!i.host,r=n&&!U.has(a),l=r?document.createDocumentFragment():i;if(((e,i,s)=>{let a=E.get(i);void 0===a&&(t(i,i.firstChild),E.set(i,a=new x(Object.assign({templateFactory:$},s))),a.appendInto(i)),a.setValue(e),a.commit()})(e,l,Object.assign({templateFactory:z(a)},s)),r){const e=E.get(l);E.delete(l);const s=e.value instanceof g?e.value.template:void 0;Y(a,l,s),t(i,i.firstChild),i.appendChild(l),E.set(i,e)}!o&&n&&window.ShadyCSS.styleElement(i.host)};var Q=/d{1,4}|M{1,4}|YY(?:YY)?|S{1,3}|Do|ZZ|Z|([HhMsDm])\1?|[aA]|"[^"]*"|'[^']*'/g,X="[^\\s]+",ee=/\[([^]*?)\]/gm;function te(e,t){for(var i=[],s=0,a=e.length;s<a;s++)i.push(e[s].substr(0,t));return i}var ie=function(e){return function(t,i){var s=i[e].map((function(e){return e.toLowerCase()})).indexOf(t.toLowerCase());return s>-1?s:null}};function se(e){for(var t=[],i=1;i<arguments.length;i++)t[i-1]=arguments[i];for(var s=0,a=t;s<a.length;s++){var o=a[s];for(var n in o)e[n]=o[n]}return e}var ae=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],oe=["January","February","March","April","May","June","July","August","September","October","November","December"],ne=te(oe,3),re={dayNamesShort:te(ae,3),dayNames:ae,monthNamesShort:ne,monthNames:oe,amPm:["am","pm"],DoFn:function(e){return e+["th","st","nd","rd"][e%10>3?0:(e-e%10!=10?1:0)*e%10]}},le=se({},re),ce=function(e,t){for(void 0===t&&(t=2),e=String(e);e.length<t;)e="0"+e;return e},de={D:function(e){return String(e.getDate())},DD:function(e){return ce(e.getDate())},Do:function(e,t){return t.DoFn(e.getDate())},d:function(e){return String(e.getDay())},dd:function(e){return ce(e.getDay())},ddd:function(e,t){return t.dayNamesShort[e.getDay()]},dddd:function(e,t){return t.dayNames[e.getDay()]},M:function(e){return String(e.getMonth()+1)},MM:function(e){return ce(e.getMonth()+1)},MMM:function(e,t){return t.monthNamesShort[e.getMonth()]},MMMM:function(e,t){return t.monthNames[e.getMonth()]},YY:function(e){return ce(String(e.getFullYear()),4).substr(2)},YYYY:function(e){return ce(e.getFullYear(),4)},h:function(e){return String(e.getHours()%12||12)},hh:function(e){return ce(e.getHours()%12||12)},H:function(e){return String(e.getHours())},HH:function(e){return ce(e.getHours())},m:function(e){return String(e.getMinutes())},mm:function(e){return ce(e.getMinutes())},s:function(e){return String(e.getSeconds())},ss:function(e){return ce(e.getSeconds())},S:function(e){return String(Math.round(e.getMilliseconds()/100))},SS:function(e){return ce(Math.round(e.getMilliseconds()/10),2)},SSS:function(e){return ce(e.getMilliseconds(),3)},a:function(e,t){return e.getHours()<12?t.amPm[0]:t.amPm[1]},A:function(e,t){return e.getHours()<12?t.amPm[0].toUpperCase():t.amPm[1].toUpperCase()},ZZ:function(e){var t=e.getTimezoneOffset();return(t>0?"-":"+")+ce(100*Math.floor(Math.abs(t)/60)+Math.abs(t)%60,4)},Z:function(e){var t=e.getTimezoneOffset();return(t>0?"-":"+")+ce(Math.floor(Math.abs(t)/60),2)+":"+ce(Math.abs(t)%60,2)}},he=function(e){return+e-1},ue=[null,"[1-9]\\d?"],pe=[null,X],be=["isPm",X,function(e,t){var i=e.toLowerCase();return i===t.amPm[0]?0:i===t.amPm[1]?1:null}],_e=["timezoneOffset","[^\\s]*?[\\+\\-]\\d\\d:?\\d\\d|[^\\s]*?Z?",function(e){var t=(e+"").match(/([+-]|\d\d)/gi);if(t){var i=60*+t[1]+parseInt(t[2],10);return"+"===t[0]?i:-i}return 0}],me=(ie("monthNamesShort"),ie("monthNames"),{default:"ddd MMM DD YYYY HH:mm:ss",shortDate:"M/D/YY",mediumDate:"MMM D, YYYY",longDate:"MMMM D, YYYY",fullDate:"dddd, MMMM D, YYYY",isoDate:"YYYY-MM-DD",isoDateTime:"YYYY-MM-DDTHH:mm:ssZ",shortTime:"HH:mm",mediumTime:"HH:mm:ss",longTime:"HH:mm:ss.SSS"});var ge=function(e,t,i){if(void 0===t&&(t=me.default),void 0===i&&(i={}),"number"==typeof e&&(e=new Date(e)),"[object Date]"!==Object.prototype.toString.call(e)||isNaN(e.getTime()))throw new Error("Invalid Date pass to format");var s=[];t=(t=me[t]||t).replace(ee,(function(e,t){return s.push(t),"@@@"}));var a=se(se({},le),i);return(t=t.replace(Q,(function(t){return de[t](e,a)}))).replace(/@@@/g,(function(){return s.shift()}))},fe=(function(){try{(new Date).toLocaleDateString("i")}catch(e){return"RangeError"===e.name}}(),function(){try{(new Date).toLocaleString("i")}catch(e){return"RangeError"===e.name}}(),function(){try{(new Date).toLocaleTimeString("i")}catch(e){return"RangeError"===e.name}}(),function(e,t,i,s){s=s||{},i=null==i?{}:i;var a=new Event(t,{bubbles:void 0===s.bubbles||s.bubbles,cancelable:Boolean(s.cancelable),composed:void 0===s.composed||s.composed});return a.detail=i,e.dispatchEvent(a),a}),ye={name:"Bodymiscale Card",description:"Mit der bodymiscal-Karte können Sie Ihren Körperwert anzeigen.",not_available:"Bodymiscale ist nicht verfügbar",toggle_power:"Punktzahl anzeigen / Punktzahl ausblenden"},we={ok:"OK",problem:"Problem",none:"Nein","weight unavailable":"Nicht verfügbares Gewicht","impedance unavailable":"Impedanz nicht verfügbar","weight unavailable, impedance unavailable":"Gewicht nicht verfügbar, Impedanz nicht verfügbar"},ve={"weight: ":"Gewicht: ","impedance: ":"Impedanz: ","height: ":"Schnitt: ","age: ":"Alter: ","gender: ":"Nett: "},Se={male:"Mann",female:"Frauen","unavailable kg":"nicht verfügbar","unavailable ohm":"nicht verfügbar"},ke={water:"Wasser",visceral_fat:"Bauchfett",body_fat:"Körperfett",bmi:"BMI",muscle_mass:"Muskelmasse",protein:"Protein",basal_metabolism:"Grundumsatz",bone_mass:"Knochenmasse",metabolic_age:"Körperalter",ideal:"Ideal",body_type:"Körpertyp"},xe={Skinny:"Dünn","Balanced-skinny":"Balanced-dünn","Skinny-muscular":"Skinny-muskulös",Balanced:"Ausgeglichen","Balanced-muscular":"Ausgewogen-muskulös","Lack-exerscise":"Bewegungsmangel","Thick-set":"Stämmig",Obese:"Fettleibig",Overweight:"Übergewicht"},Pe={" years":" jahre"},Me={missing_entity:"Bitte definieren Sie eine Entity.",missing_enttity_bodymiscale:"Bitte definieren Sie eine bodymiscale Entity.",missing_model:"Bitte definieren Sie ein gültiges Maßstabsmodell."},Ae={entity:"Entity (erforderlich)",show_name:"Name anzeigen",show_name_aria_label_on:"Namen anzeigen anschalten",show_name_aria_label_off:"Namen anzeigen ausschalten",show_state:"Status anzeigen",show_state_aria_label_on:"Status anzeigen anschalten",show_state_aria_label_off:"Status anzeigen ausschalten",show_attributes:"Attribute anzeigen anschalten",show_attributes_aria_label_on:"Attribute anzeigen anschalten",show_attributes_aria_label_off:"Attribute anzeigen ausschalten",show_body:"Körperwert anzeigen",show_body_aria_label_on:"Körperwert anzeigen anschalten",show_body_aria_label_off:"Körperwert anzeigen ausschalten",show_buttons:"Taste anzeigen anschalten",show_buttons_aria_label_on:"Taste anzeigen anschalten",show_buttons_aria_label_off:"Taste anzeigen ausschalten",show_toolbar:"Symbolleiste anzeigen",show_toolbar_aria_label_on:"Symbolleiste anzeigen anschalten",show_toolbar_aria_label_off:"Symbolleiste anzeigen ausschalten",code_only_note:"Bitte beachten: Aktionen und Status Optionen sind nur im Code Editor verfügbar."},Ne={common:ye,state:we,attributes:ve,attributes_value:Se,body:ke,body_value:xe,unit:Pe,error:Me,editor:Ae},Oe={name:"Bodymiscale Card",description:"The bodymiscale card allows you to display your body score.",not_available:"Bodymiscale is not avaialable",toggle_power:"Show score/Hide score"},Ce={ok:"OK",problem:"Problem",none:"None","weight unavailable":"Weight unavailable","impedance unavailable":"Impedance unavailable","weight unavailable, impedance unavailable":"Weight unavailable, impedance unavailable"},$e={"weight: ":"Weight: ","impedance: ":"Impedance: ","height: ":"Height: ","age: ":"Age: ","gender: ":"Gender: "},Te={male:"male",female:"female","unavailable kg":"unavailable","unavailable ohm":"unavailable"},Ee={water:"Water",visceral_fat:"Visceral fat",body_fat:"Body fat",bmi:"BMI",muscle_mass:"Muscle mass",protein:"Protein",basal_metabolism:"Basal metabolism",bone_mass:"Bone mass",metabolic_age:"Metabolic age",ideal:"Ideal",body_type:"Body type"},Be={Skinny:"Skinny","Balanced-skinny":"Balanced-skinny","Skinny-muscular":"Skinny-muscular",Balanced:"Balanced","Balanced-muscular":"Balanced-muscular","Lack-exerscise":"Lack-exerscise","Thick-set":"Thick-set",Obese:"Obese",Overweight:"Overweight"},je={" years":" years"},Ve={missing_entity:"Please define an entity.",missing_enttity_bodymiscale:"Please define a bodymiscale entity.",missing_model:"Please define a valid scale model."},De={entity:"Entity (Required)",show_name:"Show Name",show_name_aria_label_on:"Toggle display name on",show_name_aria_label_off:"Toggle display name off",show_state:"Show State",show_state_aria_label_on:"Toggle display state on",show_state_aria_label_off:"Toggle display state off",show_attributes:"Show Attributes",show_attributes_aria_label_on:"Toggle display attributes on",show_attributes_aria_label_off:"Toggle display attributes off",show_body:"Show Body Score",show_body_aria_label_on:"Toggle display body score on",show_body_aria_label_off:"Toggle display body score off",show_buttons:"Show Buttons",show_buttons_aria_label_on:"Toggle display buttons on",show_buttons_aria_label_off:"Toggle display buttons off",show_toolbar:"Show Toolbar",show_toolbar_aria_label_on:"Toggle display toolbar on",show_toolbar_aria_label_off:"Toggle display toolbar off",code_only_note:"Note: Setting actions and stats options are available exclusively using Code Editor."},ze={common:Oe,state:Ce,attributes:$e,attributes_value:Te,body:Ee,body_value:Be,unit:je,error:Ve,editor:De},Ie={name:"Carte Bodymiscale",description:"La carte bodymiscale vous permet d'afficher votre score de corps.",not_available:"Bodymiscale n'est pas disponible",toggle_power:"Afficher le score/Cacher le score"},Ue={ok:"OK",problem:"Problème",none:"Aucun","weight unavailable":"Poids indisponible","impedance unavailable":"Impédance indisponible","weight unavailable, impedance unavailable":"Poids indisponible, impédance indisponible"},Ye={"weight: ":"Poids: ","impedance: ":"Impédance: ","height: ":"Taille: ","age: ":"Age: ","gender: ":"Genre: "},He={male:"homme",female:"femme","unavailable kg":"indisponible","unavailable ohm":"indisponible"},Re={water:"Eau",visceral_fat:"Graisse viscérale",body_fat:"Graisse corporelle",bmi:"IMC",muscle_mass:"Muscle",protein:"Protéine",basal_metabolism:"Métabolisme de base",bone_mass:"Masse osseuse",metabolic_age:"Age corporel",ideal:"Poids idéal",body_type:"Corpulence"},qe={Skinny:"Maigre","Balanced-skinny":"Équilibré maigre","Skinny-muscular":"Maigre musclé",Balanced:"Équilibré","Balanced-muscular":"Musclé équilibré","Lack-exerscise":"Manque d'exercice","Thick-set":"Trapu",Obese:"Obèse",Overweight:"Surpoids"},Le={" years":" ans"},Fe={missing_entity:"Veuillez définir une entité.",missing_enttity_bodymiscale:"Veuillez définir une entité Bodymiscale.",missing_model:"Veuillez définir un modèle de balance valide."},We={entity:"Entité (obligatoire)",show_name:"Afficher le nom",show_name_aria_label_on:"Activer affichage du nom",show_name_aria_label_off:"Désactiver affichage du nom",show_state:"Afficher l'état",show_state_aria_label_on:"Activer l'affichage de l'état",show_state_aria_label_off:"Désactiver l'affichage de l'état",show_attributes:"Afficher les attributs",show_attributes_aria_label_on:"Activer l'affichage des attributs",show_attributes_aria_label_off:"Désactiver l'affichage des attributs",show_body:"Afficher le score du corps",show_body_aria_label_on:"Activer l'affichage du score du corps",show_body_aria_label_off:"Désactiver l'affichage du score du corps",show_buttons:"Afficher les bouttons",show_buttons_aria_label_on:"Activer l'affichage des bouttons",show_buttons_aria_label_off:"Désactiver l'affichage des bouttons",show_toolbar:"Afficher la barre d'outils",show_toolbar_aria_label_on:"Activer l'affichage de la barre d'outils",show_toolbar_aria_label_off:"Désactiver l'affichage de la barre d'outils",code_only_note:"Remarque: Les options de réglage des actions et statistiques sont disponibles exclusivement en utilisant l'éditeur de code."},Ke={common:Ie,state:Ue,attributes:Ye,attributes_value:He,body:Re,body_value:qe,unit:Le,error:Fe,editor:We},Ge={name:"Bodymiscale Card",description:"O cartão bodymiscale permite que você exiba a pontuação do seu corpo.",not_available:"Bodymiscale não é avaialável",toggle_power:"Pontuação do show/Ocultar pontuação"},Je={ok:"OK",problem:"Problema",none:"Nenhum","weight unavailable":"Peso indisponível","impedance unavailable":"Impedance indisponível","weight unavailable, impedance unavailable":"Peso indisponível, impedance indisponível"},Ze={"weight: ":"Peso: ","impedance: ":"Impedance: ","height: ":"Cintura: ","age: ":"Idade: ","gender: ":"Gênero: "},Qe={male:"macho",female:"fêmea","unavailable kg":"indisponível","unavailable ohm":"indisponível"},Xe={water:"Água",visceral_fat:"Gordura visceral",body_fat:"Gordura corporal",bmi:"IMC",muscle_mass:"Massa muscular",protein:"Proteína",basal_metabolism:"Metabolismo basal",bone_mass:"Massa óssea",metabolic_age:"Idade metabólica",ideal:"Ideal",body_type:"Tipo de corpo"},et={Skinny:"Magro","Balanced-skinny":"Magro equilibrado","Skinny-muscular":"Magro musculoso",Balanced:"Equilibrado","Balanced-muscular":"Musculoso equilibrado","Lack-exerscise":"Falta de exercício","Thick-set":"Grosso-conjunto",Obese:"Obeso",Overweight:"Sobrepeso"},tt={" years":" Anos"},it={missing_entity:"Por favor, defina uma entidade.",missing_enttity_bodymiscale:"Por favor, defina uma entidade bodymiscale.",missing_model:"Por favor, defina um modelo de escala válido."},st={entity:"Entidade (Obrigatório)",show_name:"Nome do show",show_name_aria_label_on:"Alternar o nome da exibição",show_name_aria_label_off:"Alternar o nome da exibição",show_state:"Mostrar Estado",show_state_aria_label_on:"Alternar estado de exibição ligado",show_state_aria_label_off:"Alternar estado de exibição fora",show_attributes:"Atributos do show",show_attributes_aria_label_on:"Alternar atributos de exibição em",show_attributes_aria_label_off:"Alternar atributos de exibição fora",show_body:"Mostrar pontuação corporal",show_body_aria_label_on:"Alternar a pontuação do corpo do display em",show_body_aria_label_off:"Alternar a pontuação do corpo do display fora",show_buttons:"Mostrar botões",show_buttons_aria_label_on:"Alternar botões de exibição",show_buttons_aria_label_off:"Alternar botões de exibição desligados",show_toolbar:"Mostrar barra de ferramentas",show_toolbar_aria_label_on:"Alternar a barra de ferramentas do display em",show_toolbar_aria_label_off:"Alternar barra de ferramentas de exibição fora",code_only_note:"Nota: As opções de configuração de ações e estatísticas estão disponíveis exclusivamente usando o Editor de Código."},at={common:Ge,state:Je,attributes:Ze,attributes_value:Qe,body:Xe,body_value:et,unit:tt,error:it,editor:st},ot={de:Object.freeze({__proto__:null,common:ye,state:we,attributes:ve,attributes_value:Se,body:ke,body_value:xe,unit:Pe,error:Me,editor:Ae,default:Ne}),en:Object.freeze({__proto__:null,common:Oe,state:Ce,attributes:$e,attributes_value:Te,body:Ee,body_value:Be,unit:je,error:Ve,editor:De,default:ze}),fr:Object.freeze({__proto__:null,common:Ie,state:Ue,attributes:Ye,attributes_value:He,body:Re,body_value:qe,unit:Le,error:Fe,editor:We,default:Ke}),pt_BR:Object.freeze({__proto__:null,common:Ge,state:Je,attributes:Ze,attributes_value:Qe,body:Xe,body_value:et,unit:tt,error:it,editor:st,default:at})};function nt(e,t,i){const[s,a]=e.split(".");let o;try{o=JSON.parse(localStorage.getItem("selectedLanguage"))}catch(e){o=localStorage.getItem("selectedLanguage")}const n=(o||navigator.language.split("-")[0]||"en").replace(/['"]+/g,"").replace("-","_");let r;try{r=ot[n][s][a]}catch(e){}if(void 0===r)try{r=ot.en[s][a]}catch(e){}if(void 0!==r)return""!==t&&""!==i&&(r=r.replace(t,i)),r}customElements.define("body-miscale-card-editor",class extends Z{static get properties(){return{hass:Object,_config:Object,_toggle:Boolean}}setConfig(e){this._config=e,this._config.entity||(this._config.entity=this.getEntitiesByType("bodymiscale")[0]||"",fe(this,"config-changed",{config:this._config}))}get _entity(){return this._config&&this._config.entity||""}get _show_name(){return this._config&&this._config.show_name||!1}get _show_state(){return this._config&&this._config.show_state||!1}get _show_attributes(){return this._config&&this._config.show_attributes||!1}get _show_body(){return this._config&&this._config.show_body||!1}get _show_buttons(){return this._config&&this._config.show_buttons||!1}get _show_toolbar(){return this._config&&this._config.show_toolbar||!1}getEntitiesByType(e){return Object.keys(this.hass.states).filter((t=>t.substr(0,t.indexOf("."))===e))}render(){if(!this.hass)return j``;const e=this.getEntitiesByType("bodymiscale");return j`
    ...
    `}_valueChanged(e){if(!this._config||!this.hass)return;const t=e.target;this["_"+t.configValue]!==t.value&&(t.configValue&&(""===t.value?delete this._config[t.configValue]:this._config={...this._config,[t.configValue]:void 0!==t.checked?t.checked:t.value}),fe(this,"config-changed",{config:this._config}))}static get styles(){return G`
...
input.divcheck:checked~label.divcheck {
  color: green;
                             ...
                             </div>`;return e.key+"_list"in this.stateObj.attributes&&(i||s)?this.renderDropdown(o,e.key):o}renderIcon(e){const t="water"===e.key&&"water_icon"in this.stateObj.attributes?this.stateObj.attributes.water_icon:e.icon;return j`<ha-icon icon="${t}" style="margin-right: 10px; ${this.config.styles.icon}"></ha-icon>`}renderIconbody(e){const t="Water"===e.key&&"water_icon"in this.stateObj.attributes?this.stateObj.attributes.water_icon:e.icon;return j`<div style="width: 24px; height: 24px; -webkit-mask-box-image: url('${t}'); margin-right: 10px; ${this.config.styles.iconbody}"></div>`}renderButton(e){return this.showButtons?e&&!1!==e.show?j`<ha-icon-button
    ...
    `:j``}renderDropdown(e,t){const i=this.stateObj.attributes[t],s=this.stateObj.attributes[t+"_list"];return j`
      <paper-menu-button slot="dropdown-trigger" @click="${e=>e.stopPropagation()}" style="padding: 0">
        ...
        <paper-listbox slot="dropdown-content" selected="${s.indexOf(i)}" @click="${e=>this.handleChange(e,t)}">
          ${s.map((e=>j`<paper-item value="${e}" style="text-shadow: none;">${e}</paper-item>`))}
        </paper-listbox>
      </paper-menu-button>
